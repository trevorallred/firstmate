...
A crewmate briefed to create a new project's `AGENTS.md`, restructure one that has grown large, or audit a project's agent-instruction layout loads the public `agent-instruction-architecture` skill first.
